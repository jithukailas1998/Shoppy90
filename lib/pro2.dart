...
class ProductState2 extends StatefulWidget {
  ...
  @override
  _ProductState2State createState() => _ProductState2State();
}

class _ProductState2State extends State<ProductState2> {
  @override
        ...
        body: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              subtitle: new Text("Cooker may refer to several types of cooking appliances and devices used for cooking foods."),
            ),
