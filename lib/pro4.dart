...
class ProductState4 extends StatefulWidget {
  ...
  @override
  _ProductState4State createState() => _ProductState4State();
}

class _ProductState4State extends State<ProductState4> {
  @override
        ...
        body: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              subtitle: new Text("The cashew seed is often considered a nut in the culinary sense; this cashew nut is eaten on its own, used in recipes, or processed into cashew cheese or cashew butter. Like the tree, the nut is often simply called a cashew."),
            ),
            Divider(),
